...
tgt_encoder_conv1.load_state_dict(torch.load(tgt_encoder[1]))
...
tgt_encoder_conv2.load_state_dict(torch.load(tgt_encoder[2]))
...
tgt_encoder_conv3.load_state_dict(torch.load(tgt_encoder[3]))
...
tgt_encoder_conv4.load_state_dict(torch.load(tgt_encoder[4]))
