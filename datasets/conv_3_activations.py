...
class CONV_3_ACTIVATIONS(data.Dataset):
    ...
    def __init__(self, root, train=True, transform=None, download=False, dataset='undefined'):
        ...
        self.root = 'data//UTAH//conv_3_activations//'
        self.training = dataset + "_conv_3_activations.pkl"
        self.testing = dataset + "_conv_3_activations_eval.pkl"
        self.train = train
...
def get_conv_3_activations(train, dataset):
    ...
    conv_3_activations_dataset = CONV_3_ACTIVATIONS(root=params.data_root,
                        train=train,
                        #transform=pre_process,
                        download=True,
                        dataset=dataset)

    conv_3_activations_data_loader = torch.utils.data.DataLoader(
        dataset=conv_3_activations_dataset,
        batch_size=params.batch_size,
        shuffle=False)

    return conv_3_activations_data_loader
