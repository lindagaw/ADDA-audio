...
from models import Discriminator, LeNet2Encoder, LeNet2Classifier
...
if __name__ == '__main__':
    ...
    # load models
    src_encoder = init_model(net=LeNet2Encoder(),
                             restore=params.src_encoder_restore)

    src_classifier = init_model(net=LeNet2Classifier(),
                                restore=params.src_classifier_restore)

    tgt_encoder = init_model(net=LeNet2Encoder(),
